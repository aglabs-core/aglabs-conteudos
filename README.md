...
| `PROMPT` → por post | `/conteudos/ensaio` | 5 prompts de ensaio masculino |
| `SURPRESA` | `/conteudos/surpresa` | 5 coisas que o Claude faz |
| `DICIONARIO` | `/conteudos/dicionario` | Dicionário do Claude Code, 8 termos |
...
| `PROMPT` → por post | `/conteudos/poster` | 6 prompts de pôster de produto |
| `PROMPT` → por post | `/conteudos/criativos` | 4 prompts criativos de ilusão |
| `PROMPT` → por post | `/conteudos/elegante` | 6 prompts de fotos elegantes |
